...
int main(int argc, char **argv){
	...
	queues_to_map[0] = initQ(100000, "queue_to_map0");
	queues_to_map[1] = initQ(100000, "queue_to_map1");
	queues_to_map[2] = initQ(100000, "queue_to_map2");
	queues_to_map[3] = initQ(100000, "queue_to_map3");
	queues_to_map[4] = initQ(100000, "queue_to_map4");
	fifoQ **queues_to_reduce = (fifoQ**)malloc(sizeof(fifoQ*)*5);
	queues_to_reduce[0] = initQ(100000, "queue_to_reduce0");
	queues_to_reduce[1] = initQ(100000, "queue_to_reduce1");
	queues_to_reduce[2] = initQ(100000, "queue_to_reduce2");
	queues_to_reduce[3] = initQ(100000, "queue_to_reduce3");
	queues_to_reduce[4] = initQ(100000, "queue_to_reduce4");
	...
	printQ_to_file(queues_reduced,5,out);
